...
#define MARLIN_EVT_Acknowledge         0x1b  // onAcknowledge - lowest priority
#define MARLIN_EVT_MAX                 MARLIN_EVT_Message

// event masks
#define MARLIN_EVT_MSK(e_id)           ((uint64_t)1 << (e_id))
#define MARLIN_EVT_MSK_DEF ( \
	MARLIN_EVT_MSK(MARLIN_EVT_Startup) | \
	MARLIN_EVT_MSK(MARLIN_EVT_MediaInserted) | \
	MARLIN_EVT_MSK(MARLIN_EVT_MediaError) | \
	MARLIN_EVT_MSK(MARLIN_EVT_MediaRemoved) | \
	MARLIN_EVT_MSK(MARLIN_EVT_PlayTone) | \
	MARLIN_EVT_MSK(MARLIN_EVT_PrintTimerStarted) | \
	MARLIN_EVT_MSK(MARLIN_EVT_PrintTimerPaused) | \
	MARLIN_EVT_MSK(MARLIN_EVT_PrintTimerStopped) | \
	MARLIN_EVT_MSK(MARLIN_EVT_FilamentRunout) | \
	MARLIN_EVT_MSK(MARLIN_EVT_UserConfirmRequired) | \
	MARLIN_EVT_MSK(MARLIN_EVT_StatusChanged) | \
	MARLIN_EVT_MSK(MARLIN_EVT_FactoryReset) | \
	MARLIN_EVT_MSK(MARLIN_EVT_LoadSettings) | \
	MARLIN_EVT_MSK(MARLIN_EVT_StoreSettings) | \
	MARLIN_EVT_MSK(MARLIN_EVT_MeshUpdate) | \
	MARLIN_EVT_MSK(MARLIN_EVT_HostPrompt) | \
	MARLIN_EVT_MSK(MARLIN_EVT_StartProcessing) | \
	MARLIN_EVT_MSK(MARLIN_EVT_StopProcessing) | \
	MARLIN_EVT_MSK(MARLIN_EVT_Busy) | \
	MARLIN_EVT_MSK(MARLIN_EVT_Ready) | \
	MARLIN_EVT_MSK(MARLIN_EVT_Error) | \
	MARLIN_EVT_MSK(MARLIN_EVT_CommandBegin) | \
	MARLIN_EVT_MSK(MARLIN_EVT_CommandEnd) | \
	MARLIN_EVT_MSK(MARLIN_EVT_SafetyTimerExpired) | \
	MARLIN_EVT_MSK(MARLIN_EVT_Message) | \
	MARLIN_EVT_MSK(MARLIN_EVT_Acknowledge) )


#define MARLIN_EVT_MSK_ALL ( \
	MARLIN_EVT_MSK(MARLIN_EVT_Startup) | \
	MARLIN_EVT_MSK(MARLIN_EVT_Idle) | \
