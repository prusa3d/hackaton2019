...
#define MARLIN_VAR_SD_PRINT            0x15 // RW: uint8, card.flag.sdprinting
#define MARLIN_VAR_SD_PDONE            0x16 // RW: uint8, card.percentDone()
#define MARLIN_VAR_DURATION            0x17 // RW: uint32, print_job_timer.duration()
...
#define MARLIN_VAR_MSK_IPOS_XYZE ( \
	MARLIN_VAR_MSK(MARLIN_VAR_IPOS_X) | \
	MARLIN_VAR_MSK(MARLIN_VAR_IPOS_Y) | \
	MARLIN_VAR_MSK(MARLIN_VAR_IPOS_Z) | \
	MARLIN_VAR_MSK(MARLIN_VAR_IPOS_E) )
...
#define MARLIN_VAR_MSK_TEMP_CURR ( \
	MARLIN_VAR_MSK(MARLIN_VAR_TEMP_NOZ) | \
...
#define MARLIN_VAR_MSK_DEF ( \
	...
	MARLIN_VAR_MSK(MARLIN_VAR_SD_PRINT) | \
	MARLIN_VAR_MSK(MARLIN_VAR_SD_PDONE) | \
	MARLIN_VAR_MSK(MARLIN_VAR_DURATION) )
...
#define MARLIN_VAR_MSK_ALL ( \
	...
	MARLIN_VAR_MSK(MARLIN_VAR_WAITHEAT) | \
	MARLIN_VAR_MSK(MARLIN_VAR_WAITUSER) | \
	MARLIN_VAR_MSK(MARLIN_VAR_SD_PRINT) | \
	MARLIN_VAR_MSK(MARLIN_VAR_SD_PDONE) | \
	MARLIN_VAR_MSK(MARLIN_VAR_DURATION) )
