...
typedef struct
{
	...
	window_numb_t     numb_noz;
	window_icon_t     icon_wizard_noz;
	window_text_t     text_progress_noz;
	window_progress_t progress_noz;

	window_text_t     text_bed;
	window_numb_t     numb_bed;
	window_icon_t     icon_wizard_bed;
	window_text_t     text_progress_bed;
	window_progress_t progress_bed;
