...
#define _STATE_MASK_WIZARD_START ( \
	_STATE_MASK(_STATE_START) | \
	_STATE_MASK(_STATE_INIT) | \
	_STATE_MASK(_STATE_INFO) | \
	_STATE_MASK(_STATE_FIRST) )

#define _STATE_MASK_SELFTEST (\
	_STATE_MASK(_STATE_SELFTEST_INIT) | \
	_STATE_MASK(_STATE_SELFTEST_FAN0) | \
	_STATE_MASK(_STATE_SELFTEST_FAN1) | \
	_STATE_MASK(_STATE_SELFTEST_X) | \
	_STATE_MASK(_STATE_SELFTEST_Y) | \
	_STATE_MASK(_STATE_SELFTEST_Z) | \
	_STATE_MASK(_STATE_SELFTEST_HOME) | \
	_STATE_MASK(_STATE_SELFTEST_COOL) | \
	_STATE_MASK(_STATE_SELFTEST_INIT_TEMP) | \
	_STATE_MASK(_STATE_SELFTEST_TEMP) | \
	_STATE_MASK(_STATE_SELFTEST_PASS) | \
	_STATE_MASK(_STATE_SELFTEST_FAIL) | \
	_STATE_MASK(_STATE_LAST) )

#define _STATE_MASK_XYZCALIB (\
	_STATE_MASK(_STATE_XYZCALIB_INIT) | \
	_STATE_MASK(_STATE_XYZCALIB_HOME) | \
	_STATE_MASK(_STATE_XYZCALIB_Z) | \
	_STATE_MASK(_STATE_XYZCALIB_XY_MSG_CLEAN_NOZZLE) | \
	_STATE_MASK(_STATE_XYZCALIB_XY_MSG_IS_SHEET) | \
	_STATE_MASK(_STATE_XYZCALIB_XY_MSG_REMOVE_SHEET) | \
	_STATE_MASK(_STATE_XYZCALIB_XY_MSG_PLACE_PAPER) | \
	_STATE_MASK(_STATE_XYZCALIB_XY_SEARCH) | \
	_STATE_MASK(_STATE_XYZCALIB_XY_MSG_PLACE_SHEET) | \
	_STATE_MASK(_STATE_XYZCALIB_XY_MEASURE) | \
	_STATE_MASK(_STATE_XYZCALIB_PASS) | \
	_STATE_MASK(_STATE_XYZCALIB_FAIL) | \
	_STATE_MASK(_STATE_LAST) )

#define _STATE_MASK_FIRSTLAY (\
	_STATE_MASK(_STATE_FIRSTLAY_INIT) | \
	_STATE_MASK(_STATE_FIRSTLAY_LOAD) | \
	_STATE_MASK(_STATE_FIRSTLAY_MSBX_CALIB) | \
	_STATE_MASK(_STATE_FIRSTLAY_MSBX_START_PRINT) | \
	_STATE_MASK(_STATE_FIRSTLAY_PRINT) | \
	_STATE_MASK(_STATE_FIRSTLAY_MSBX_REPEAT_PRINT) | \
	_STATE_MASK(_STATE_FIRSTLAY_FAIL) | \
	_STATE_MASK(_STATE_LAST) )
/*
